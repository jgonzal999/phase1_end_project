package phase1.enhancedapp.com;

import java.util.ArrayList;
import java.util.Scanner;

import phase1.enhancedapp.utility.BussinessOperationsE;
import phase1.enhancedapp.utility.MenusE;
import phase1.enhancedapp.utility.UsersE;
import phase1.enhancedapp.exception.ValueExceptionE;
			...
			do {			
				do {
					...
					try {
						op = sc.nextInt();
						if (op<1 || op>3) {
							throw new ValueExceptionE(" Sorry, please enter a value between 1 and 3");
						}
					}catch(Exception e) {
						op=100;
						sc.nextLine();
							...
							do {
								do {
									...
									try {
										op2 = sc.nextInt();
										if (op2<1 || op2>6) {
											throw new ValueExceptionE(" Sorry, please enter a value between 1 and 5");
										}
									}catch(Exception e) {
										op2=100;
										sc.nextLine();
